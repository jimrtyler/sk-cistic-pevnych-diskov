...
#GUI Variables
$FormTitleText = "Čistič diskov od Jima Tylera (PowerShellEngineer.com)"
$SelectDiskLabelText = "Vybrať disk:"
$FreeSpaceLabelText = "Voľné miesto (gigabajty): "
$TotalSpaceLabelText = "Celkový priestor (gigabajty): "
$JunkFoundLabelText = "nájdený odpad (gigabajty):"
$CleanDiskBtnText = "Vyčistiť disk *Odstrániť súbory*"
$SpaceCleanedLabelText = "Vyčistený priestor (gigabajty): "
$LogFileLabelText = "Našiel sa súbor denníka: $abcdefg"
$CreditLabelText = "Scenár od Jima Tylera - PowerShellEngineer.com"
$LogFileLocatedText = "Našiel sa súbor denníka"
$AnalyzingDriveText = "Analýza diskov..."
$BrowsersAreRunningText = "Prehliadače sú spustené... Upozorniť užívateľa..."
$PleaseCloseBrowsersText = "Zatvorte všetky webové prehliadače a skúste to znova."
$CleaningDriveText = "Čistenie disku..."
